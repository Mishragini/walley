  ...
  return (
    <div className="flex flex-col justify-between h-full py-8 items-center">
      <div className="flex flex-col items-center  justify-center gap-4">
        <div className="flex bg-[#202127] items-center justify-center rounded-full aspect-square p-4 w-20 h-20">
          <Image src="/wallet.png" alt="wallet-icon" width={32} height={32} />
        </div>
        <div className="text-2xl font-medium ">Welcome to Wallet</div>
        <div className="text-[#969FAF] font-medium text-base">{`You'll use this wallet to send and receive crypto and NFTs`}</div>
      </div>
